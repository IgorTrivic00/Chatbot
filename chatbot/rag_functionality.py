...
def rag_func(question: str, section: str) -> str:
    # Dodajemo filtriranje na osnovu odeljka
    modified_question = f"Odeljak: {section}. {question}"
    
    # call QA chain
    response = qa_chain.invoke({"question": modified_question})
