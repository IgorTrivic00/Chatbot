import warnings
from langchain_huggingface import HuggingFaceEmbeddings  # Ažurirani import
from langchain_community.vectorstores import Chroma  # Ažurirani import
from langchain_openai import ChatOpenAI  # Ažurirani import
...
# call QA chain using invoke instead of __call__
